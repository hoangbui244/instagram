    ...
    <div id="myModal" class="modal">
        ...
        <div class="modal_content">
            ...
            <div class="modal_header">
                ...
                <h5 id="btn_continude">Tiếp</h3>
            </div>
            <div class="modal_need_hidden">
                <img class="img_add" src="img/modal/add.png" alt="">
                <h4>Kéo ảnh và video vào đây</h4>
                <button onclick="defaultBtnActive()" id="custom-btn" class="btn_choose_img">Chọn từ máy tính</button>
            </div>


            <input id="default-btn" type="file" hidden>

            <img class="image_show" src="" alt="">
    ...
    <div id="model_push" class="modal_push_feed">
        <div class="model_push_content">
            ...
            <div class="modal_header">
                ...
                <h5>Tạo bài viết mới</h5>
                <h5 id="btn_share">Chia sẻ</h3>
            </div>
            <div class="modal_push_image_avatar">
                <div class="modal_push_image">
                    <img class="image_push_modal" src="img/main/2.jpg" alt="">
                </div>
